...
## Environments
- Preview: https://main--itc-aashirvaadsvasti--aemysites.aem.page/
- Live: https://main--itc-aashirvaadsvasti--aemysites.aem.live/
- Block Library: https://main--itc-aashirvaadsvasti--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `itc-aashirvaadsvasti` directory in your favorite IDE and start coding :)
